...
export function ConsoleDelegations() {
  ...
  return (
    <ConsoleLayout breadcrumb="Delegations" onExport={handleExport}>
      <div>
        <h1 className="font-display text-[26px] font-semibold tracking-[-0.01em] text-gray-900">Delegations</h1>
