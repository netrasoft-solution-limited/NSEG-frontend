...
{ icon: CrownIcon, label: 'Trust & badging', href: '/console/trust-badging' },
{ icon: BriefcaseIcon, label: 'Opportunities', href: '/console/opportunities' },
{ icon: GlobeIcon, label: 'Market intelligence', href: '/console/market-intelligence' },
...
{ icon: UsersRoundIcon, label: 'Delegations', href: '/console/delegations' },
