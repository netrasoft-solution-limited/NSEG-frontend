...
import { ChevronDownIcon, CompassIcon, LockIcon, OctagonAlertIcon, ShieldCheckIcon } from 'lucide-react';
...
const navItems: { to: string; label: string; icon: IconComponent; end?: boolean }[] = [
...
export function WorkspaceLayout({ title, intro, children }: WorkspaceLayoutProps) {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 text-gray-900 [color-scheme:light]">
        ...
        <div className="mx-auto flex max-w-4xl flex-wrap items-center gap-3 px-4 pt-3">
          <Link
            ...
            <span className="leading-tight">
              ...
              <span className="block text-[11.5px] text-gray-600">Exporter workspace</span>
            </span>
          </Link>
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="relative">
              <select
                ...
                {(['firm', 'individual'] as const).map((track) =>
                <optgroup key={track} label={trackLabels[track]}>
                    {actors.
      ...
      <main id="workspace-main" className="mx-auto max-w-4xl px-4 pb-16 pt-5">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate text-[14px] font-semibold text-gray-900">{actor.name}</p>
